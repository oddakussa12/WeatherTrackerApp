      ...
      <div class="modal-content" style="border-radius: 15px;">
        <form method="POST" id="delete_form">
            ...
            <div class="modal-body">
                ...
                <p class="font-weight-bold mb-2" style="font-family: Arial, Helvetica, sans-serif;"> Are you sure you wanna delete city
                    <strong id="deleteitemname"></strong> 
                </p>
                <p class="text-muted" style="font-family: Arial, Helvetica, sans-serif;"> This will also delete weather records of the city</p>
